...
<script type="text/javascript">
	...
	function optDelete(name,isDisplay,pageNo){
		...
		//js提交
		$("#listForm").attr("action","/brand/dels.do?name="+name+"&isDisplay="+isDisplay+"&pageNo="+pageNo);
...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<c:forEach items="${pagination.list}" var="brand">
		<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
			...
			<td align="center">
			<a class="pn-opt" href="/brand/toEdit.do?id=${brand.id}">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}" href="/brand/toDel.do?id=${brand.id}">删除</a>
			</td>
		</tr>
	</c:forEach>
	</tbody>
